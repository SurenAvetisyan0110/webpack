...
function Room1() {
  ...
  productArr1 = productArr.filter(item => item.filter == "room1")
...
function Room2() {
  productContent.innerHTML =``
  productArr1 = productArr.filter(item => item.filter == "room2")
...
function Room3() {
  productContent.innerHTML =``
  productArr1 = productArr.filter(item => item.filter == "room3")
