...
import { filterContent, productContent } from "./GlobeSection"
import { HeartIcon } from "./state"
import { CartIcon } from "./state"
import { cartArr } from "./GlobeSection"
import { likeArr } from "./GlobeSection"

export let productArr1 = []

export function GlobeSectionHouse(){
  productContent.innerHTML =``
  filterContent.innerHTML =``

  productArr1 = productArr.filter(item => item.type == "house")
